...
% Calcola i k centroidi prendendoli casualmente tra le osservazioni, la
% funzione lavora su una lista Obs, che viene ogni volta accorciata
% rimuovendo l'elelmento preso casualmente
